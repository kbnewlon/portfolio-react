                        ...
                        <div className="col-lg-4">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>Click <a href="https://github.com/kbnewlon" target="_blank"  rel="noreferrer">here</a> to view my Github profile</p>
                        ...
                        <div className="col-lg-4">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>Click <a href="https://www.linkedin.com/in/kayla-newlon/" target="_blank"  rel="noreferrer">here</a> to view my LinkedIn profile</p>
                                </div>
                            </div>
                        </div>
