...
function Projects() {
    return (
        <>
            <h1 className="headerPortfolio">PROJECTS IM PROUD OF</h1>
            <Container className="portfolioDiv">
                <Row>
                    <Col md={4}>
                        <Card className="portfolioCard" style={{ width: '24rem' }} >
                    ...
                    <Col md={4}>
                        <Card className="portfolioCard" style={{ width: '24rem' }}>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                    <p>Quarantine keeping you from eating what you really want? This virtual burger application combines the use MySQL, Node, Express, Handlebars, as well as its very own homemade ORM (yum!)</p>
                                    <p> Don't bother with those pesky germs, Use this app to create and DEVOUR your very own virtual burger.</p>
                                    <p>Bon appetit!</p>
                                </Card.Text>
